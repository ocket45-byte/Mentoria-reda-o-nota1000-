...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin:0; padding:0; }
    ...
    .benefit-card { flex:1 1 calc(50% - 16px); background:#fefefe; padding:16px; border-radius:10px; box-shadow:0 6px 18px rgba(0,0,0,0.08); font-weight:500; }
    @media(max-width:768px){ .benefits-cards { flex-direction:column; } .benefit-card { flex:1 1 100%; } }
  </style>
</head>
<body>
  <div class="container">
    ...
    <!-- HERO -->
    <div class="hero">
      <h1>Garanta a Nota Máxima na Redação do ENEM em 14 Dias!</h1>
    ...
    <div class="section" style="text-align:center;">
      ...
      <div class="price">R$ 37,00</div>
      <a href="https://pay.kiwify.com.br/j4SluVK" class="cta">📘 Sim, quero minha redação nota 1000 agora</a>
    </div>
