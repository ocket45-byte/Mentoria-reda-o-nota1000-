    ...
    <div class="section">
      ...
      <div class="testimonials">
        <div class="testimonial">
          "Nunca pensei que conseguiria 900+ na redação! Este guia mudou meu jeito de estudar."
          <strong>— Ana, SP</strong>
        </div>
        <div class="testimonial">
          "Em 2 semanas consegui organizar meu repertório e aumentar minha nota de 680 para 880."
          <strong>— Lucas, MG</strong>
        </div>
        <div class="testimonial">
          "Cheguei no dia da prova com segurança. O método é direto e simples de aplicar."
          <strong>— Carla, PR</strong>
        </div>
      </div>
    </div>
